/**
 * ExileClient_util_item_getMainStats
 *
 * Exile Mod
 * www.exilemod.com
 * © 2015 Exile Mod Team
...
private["_itemClassName", "_itemType", "_stats", "_armor", "_mass", "_containerClass", "_capacity", "_ammoClassName", "_damage", "_aoeRadius", "_maxControlRange", "_triggerRadius", "_maxRange", "_explosionTime", "_typicalSpeed", "_tracersEvery", "_attributeName", "_attributeId", "_effectValue", "_effectDuration", "_effectSign", "_effectUnit", "_modes", "_highestRange", "_lowestDispersion", "_lowestReloadTime", "_roundsPerMinute", "_popTabs"];
