/**
 * ExileClient_gui_clan_context_event_onPolyAddButtonClick
 *
 * Exile Mod
 * www.exilemod.com
 * © 2015 Exile Mod Team
...
_createMenu = uiNamespace getVariable ['RscExileMapCreatePoly', displayNull];
if(!isNull _createMenu)then
{
	...
	_createMenu call ExileClient_gui_clan_polyAddMenu_event_onLoad;
};
true